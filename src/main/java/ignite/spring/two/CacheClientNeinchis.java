...
public class CacheClientNeinchis {
	...
	public static void main(String[] args) throws IgniteException {
		...
		try {
			Ignite ignite = Ignition.start("C:\\javaDev\\apache-ignite\\examples\\config\\example-ignite.xml");
			...
			System.err.println("exceptie la pornite nodului ignite client");
		}
	}
}
